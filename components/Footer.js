...
export default function Footer () {
  return (
    <div>
        <footer className=' relative bottom-0 text-white shadow-[0px_30px_90px_50px_rgba(0,0,0,0.3)] w-full'>
...
{/* <footer class=" fixed bottom-0 w-full p-4 bg-white sm:p-6 dark:bg-gray-900">
