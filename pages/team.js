...
function Team() {
  ...
  return (
    <div>
        ...
        <button className = "font-extrabold w-50 text-transparent text-8xl bg-clip-text bg-gradient-to-r from-indigo-400 via-cyan-400 to-white mt-20 mb-10  hover:from-blue-100 hover:to-green-500">
            Our Team</button>
        </div>
